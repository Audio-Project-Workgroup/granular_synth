static MemberDefinition membersOf_PluginState[] =
{
  ...
  {STR8_LIT("LoadedBitmap"), STR8_LIT("nullTexture"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("editorReferenceLayout"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("editorSkin"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("pomegranateKnob"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("pomegranateKnobLabel"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("halfPomegranateKnob"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("halfPomegranateKnobLabel"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("densityKnob"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("densityKnobShadow"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("densityKnobLabel"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("levelBar"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("levelFader"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("grainViewBackground"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("grainViewOutline"), 0, 0, 0},
  {STR8_LIT("LoadedFont"), STR8_LIT("testFont"), 0, 0, 0},
  {STR8_LIT("LoadedFont"), STR8_LIT("agencyBold"), 0, 0, 0},
...
static MemberDefinition membersOf_UIPanel[] =
{
  ...
  {STR8_LIT("LoadedBitmap"), STR8_LIT("texture"), 1, 0, 0},
...
static MemberDefinition membersOf_GrainManager[] =
{
  ...
  {STR8_LIT("r32"), STR8_LIT("windowBuffer"), 1, 0, WindowShape_count},
};

static MemberDefinition membersOf_GrainStateView[] =
{
  {STR8_LIT("u32"), STR8_LIT("viewReadIndex"), 0, 0, 0},
  {STR8_LIT("u32"), STR8_LIT("viewWriteIndex"), 0, 0, 0},
  {STR8_LIT("u32"), STR8_LIT("entriesQueued"), 0, 0, 0},
  {STR8_LIT("GrainBufferViewEntry"), STR8_LIT("views"), 0, 0, 32},
  {STR8_LIT("AudioRingBuffer"), STR8_LIT("viewBuffer"), 0, 0, 0},
};
...
static MemberDefinition membersOf_PluginFloatParameter[] =
{
  ...
  {STR8_LIT("u32"), STR8_LIT("lock"), 0, 0, 0},
  {STR8_LIT("ParameterValue"), STR8_LIT("currentValue"), 0, 0, 0},
  {STR8_LIT("ParameterValue"), STR8_LIT("targetValue"), 0, 0, 0},
  {STR8_LIT("ParameterValue"), STR8_LIT("dValue"), 0, 0, 0},
};
...
static MemberDefinition membersOf_UILayout[] =
{
  ...
  {STR8_LIT("UISizeType"), STR8_LIT("currentOffsetSizeType"), 0, 0, 0},
  {STR8_LIT("UISizeType"), STR8_LIT("currentDimSizeType"), 0, 0, 0},
...
static MemberDefinition membersOf_Grain[] =
{
  ...
  {STR8_LIT("r32"), STR8_LIT("windowParam"), 0, 0, 0},
  {STR8_LIT("s32"), STR8_LIT("samplesToPlay"), 0, 0, 0},
  {STR8_LIT("u32"), STR8_LIT("length"), 0, 0, 0},
  {STR8_LIT("r32"), STR8_LIT("lengthInv"), 0, 0, 0},
  {STR8_LIT("r32"), STR8_LIT("stereoPosition"), 0, 0, 0},
};

static MemberDefinition membersOf_GrainBufferViewEntry[] =
{
  ...
  {STR8_LIT("u32"), STR8_LIT("sampleCapacity"), 0, 0, 0},
  {STR8_LIT("r32"), STR8_LIT("bufferSamples"), 1, 0, 2},
  {STR8_LIT("u32"), STR8_LIT("grainCount"), 0, 0, 0},
  {STR8_LIT("GrainViewEntry"), STR8_LIT("grainViews"), 0, 0, 32},
};
...
static MemberDefinition membersOf_UIElement[] =
{
  ...
  {STR8_LIT("v4"), STR8_LIT("color"), 0, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("texture"), 1, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("secondaryTexture"), 1, 0, 0},
  {STR8_LIT("LoadedBitmap"), STR8_LIT("labelTexture"), 1, 0, 0},
  {STR8_LIT("v2"), STR8_LIT("labelOffset"), 0, 0, 0},
  {STR8_LIT("v2"), STR8_LIT("labelDim"), 0, 0, 0},
  {STR8_LIT("v2"), STR8_LIT("textOffset"), 0, 0, 0},
  ...
  {STR8_LIT("Rect2"), STR8_LIT("region"), 0, 0, 0},
  {STR8_LIT("Rect2"), STR8_LIT("clickableRegion"), 0, 0, 0},
...
static MemberDefinition membersOf_GrainViewEntry[] =
{
  {STR8_LIT("u32"), STR8_LIT("startIndex"), 0, 0, 0},
  {STR8_LIT("u32"), STR8_LIT("endIndex"), 0, 0, 0},
};

static MetaStruct metaStructs[] =
{
  {STR8_LIT("GrainViewEntry"), membersOf_GrainViewEntry},
  {STR8_LIT("UIElement"), membersOf_UIElement},
  {STR8_LIT("LoadedSound"), membersOf_LoadedSound},
  {STR8_LIT("GrainBufferViewEntry"), membersOf_GrainBufferViewEntry},
